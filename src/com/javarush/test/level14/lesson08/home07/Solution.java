...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament rr : apartaments)
        {
            if (rr instanceof Apt1Room) ((Apt1Room) rr).clean1Room();
            else if (rr instanceof Apt2Room) ((Apt2Room) rr).clean2Rooms();
            else if (rr instanceof Apt3Room) ((Apt3Room) rr).clean3Rooms();
        }
    }

...
public class Solution {
    ...
    public static void switchTest(Enum obj) {
        ...
        switch (obj.getDeclaringClass().getSimpleName()) {
            case "E1": System.out.println("it's " + obj.getDeclaringClass().getSimpleName() + "." + obj.toString());
                break;
            case "E2": System.out.println("it's " + obj.getDeclaringClass().getSimpleName() + "." + obj.toString());
                break;
            default:
